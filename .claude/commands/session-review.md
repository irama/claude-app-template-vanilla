...
3. **TypeScript clean** — run `pnpm run typecheck` and fix all errors
4. **Lint clean** — run `pnpm run lint` and fix all warnings and errors
5. **Tests pass** — run `pnpm exec vitest run` and fix any failures
